...
from .views import p2MaestrosCarreraPDF, p2MaestrosHoraPDF, p2MaestrosIndiceAltoPDF, p2MaestrosIndiceBajoPDF, p2AllMaestrosPDF, p2MaeNoCalif, p2MaeNoCalifPDF
urlpatterns = [
    ...
    path('p2MaeNCPDF',p2MaeNoCalifPDF),
]
